...
CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PTHLM(:,:),ZTHLM_F)
CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PRTM(:,:), ZRTM_F )
CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PUM(:,:),  ZUM_F  )
CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PVM(:,:),  ZVM_F  )
CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PTKEM(:,:),ZTKEM_F)

DO JSV=1,ISV
  IF (ONOMIXLG .AND. JSV >= KSV_LGBEG .AND. JSV<= KSV_LGEND) CYCLE
  CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PSVM(:,:,JSV), ZSVM_F(:,:,JSV))
END DO
!                     
...
IF (OENTR_DETR) THEN
  CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PTHM (:,:),     ZTHM_F )
  CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PPABSM(:,:),    ZPRES_F) 
  CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PRHODREF(:,:),  ZRHO_F )   
  CALL MZM_MF(KLON,KLEV,KKA,KKU,KKL,PRVM(:,:),      ZRVM_F )
