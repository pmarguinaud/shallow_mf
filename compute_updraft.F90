...
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PTHLM,ZTHLM_F,KSTPT,KSTSZ,PSTACK)
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PRTM, ZRTM_F,KSTPT,KSTSZ,PSTACK )
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PUM,  ZUM_F,KSTPT,KSTSZ,PSTACK  )
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PVM,  ZVM_F,KSTPT,KSTSZ,PSTACK  )
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PTKEM,ZTKEM_F,KSTPT,KSTSZ,PSTACK)

DO JSV=1,ISV
  IF (ONOMIXLG .AND. JSV >= KSV_LGBEG .AND. JSV<= KSV_LGEND) CYCLE
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PSVM(:,:,JSV), ZSVM_F(:,:,JSV),KSTPT,KSTSZ,PSTACK)
END DO
!                     
...
IF (OENTR_DETR) THEN
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PTHM ,     ZTHM_F,KSTPT,KSTSZ,PSTACK )
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PPABSM,    ZPRES_F,KSTPT,KSTSZ,PSTACK) 
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PRHODREF,  ZRHO_F,KSTPT,KSTSZ,PSTACK )   
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PRVM,      ZRVM_F,KSTPT,KSTSZ,PSTACK )
  ...
  CALL TH_R_FROM_THL_RT_1D(KLON,KIDIA,KFDIA,HFRAC_ICE,PFRAC_ICE_UP(:,KKB),ZPRES_F(:,KKB), &
             ...
             PRV_UP(:,KKB),PRC_UP(:,KKB),PRI_UP(:,KKB),ZRSATW,ZRSATI,KSTPT,KSTSZ,PSTACK)
  ...
  CALL COMPUTE_BL89_ML(KLON,KIDIA,KFDIA,KLEV,KKA,KKB,KKE,KKU,KKL,PDZZ,ZTKEM_F(:,KKB),&
                       ZG_O_THVREF(:,KKB),ZTHVM,KKB,GLMIX,.TRUE.,ZLUP,KSTPT,KSTSZ,PSTACK)
...
! Compute non cons. var. at level JK+KKL
  ...
  CALL TH_R_FROM_THL_RT_1D(KLON,KIDIA,KFDIA,HFRAC_ICE,PFRAC_ICE_UP(:,JK+KKL),ZPRES_F(:,JK+KKL), &
          ...
          ZRV_UP,ZRC_UP,ZRI_UP,ZRSATW,ZRSATI,KSTPT,KSTSZ,PSTACK)
  WHERE(GTEST(KIDIA:KFDIA))
