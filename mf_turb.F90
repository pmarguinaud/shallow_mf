...
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PTHLM,ZMZM,ISTPT,KSTSZ,PSTACK)
PFLXZTHMF(KIDIA:KFDIA,:) = PEMF(KIDIA:KFDIA,:)*(PTHL_UP(KIDIA:KFDIA,:)-ZMZM(KIDIA:KFDIA,:))

CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PRTM,ZMZM,ISTPT,KSTSZ,PSTACK)
PFLXZRMF(KIDIA:KFDIA,:) =  PEMF(KIDIA:KFDIA,:)*(PRT_UP(KIDIA:KFDIA,:)-ZMZM(KIDIA:KFDIA,:))

CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PTHVM,ZMZM,ISTPT,KSTSZ,PSTACK)
PFLXZTHVMF(KIDIA:KFDIA,:) = PEMF(KIDIA:KFDIA,:)*(PTHV_UP(KIDIA:KFDIA,:)-ZMZM(KIDIA:KFDIA,:))

IF (OMIXUV) THEN
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PUM,ZMZM,ISTPT,KSTSZ,PSTACK)
  PFLXZUMF(KIDIA:KFDIA,:) =  PEMF(KIDIA:KFDIA,:)*(PU_UP(KIDIA:KFDIA,:)-ZMZM(KIDIA:KFDIA,:))
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PVM,ZMZM,ISTPT,KSTSZ,PSTACK)
...
CALL TRIDIAG_MASSFLUX(KLON,KIDIA,KFDIA,KLEV,KKA,KKB,KKE,KKU,KKL,PTHLM,PFLXZTHMF,ZMEMF,PTSTEP_MET,PIMPL,  &
                      PDZZ,PRHODJ,ZVARS,ISTPT,KSTSZ,PSTACK )
! compute new flux
CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,ZVARS,ZMZM,ISTPT,KSTSZ,PSTACK)
PFLXZTHMF(KIDIA:KFDIA,:) = PEMF(KIDIA:KFDIA,:)*(PTHL_UP(KIDIA:KFDIA,:)-ZMZM(KIDIA:KFDIA,:))
...
DO JSV=1,ISV 
  ...
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,PSVM(:,:,JSV),ZMZM,ISTPT,KSTSZ,PSTACK)
  ...
  CALL TRIDIAG_MASSFLUX(KLON,KIDIA,KFDIA,KLEV,KKA,KKB,KKE,KKU,KKL,PSVM(:,:,JSV),PFLXZSVMF(:,:,JSV),&
                        ZMEMF,PTSTEP_SV,PIMPL,PDZZ,PRHODJ,ZVARS,ISTPT,KSTSZ,PSTACK )
  ! compute new flux
  CALL MZM_MF(KLON,KIDIA,KFDIA,KLEV,KKA,KKU,KKL,ZVARS,ZMZM,ISTPT,KSTSZ,PSTACK)
  PFLXZSVMF(KIDIA:KFDIA,:,JSV) = PEMF(KIDIA:KFDIA,:)*(PSV_UP(KIDIA:KFDIA,:,JSV)-ZMZM(KIDIA:KFDIA,:))
